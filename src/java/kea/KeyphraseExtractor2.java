...
public class KeyphraseExtractor2 {

  public static final String TRAINING_DATA_DIR = "data/fao780";
  public static final String TRAINING_DATA_ENCODING = "ISO-8859-1";
  public static final String LUCENE_INDEX_DIR = "index2";
  public static final String FILE_NAME = "filename";
  public static final String FIELD_NAME = "content";
  public static final String DOC_SIZE_FIELD_NAME = "size";
  public static final String filename = "t0073e";
    ...
    try{
      for(int n = 1; n <= 3; n++){
        ...
        for(BytesRef rawPhrase = te.next(); rawPhrase != null; rawPhrase = te.next()){
          ...
          double[] features = getFeatures(ir, fieldName, rawPhrase, docId, docSize, numDocs, true);
